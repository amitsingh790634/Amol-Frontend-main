...
Brooklyn, NY 11216""",
  ...
  DraggableScrollableSheet getCard1() {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        title: const Text('1:00 Pm to 2:00 Pm'),
                      ...
                      ListTile(
                        title: const Text('2:00 Pm to 3:00 Pm'),
                        leading: Radio<SingingCharacter>(
                      ...
                      ListTile(
                        title: const Text('3:00 Pm to 4:00 Pm'),
                        leading: Radio<SingingCharacter>(
                          value: SingingCharacter.jefferson,
                          groupValue: _character,
                          onChanged: (SingingCharacter? value) {
                      ...
                      ListTile(
                        title: const Text('4:00 Pm to 5:00 Pm'),
                        leading: Radio<SingingCharacter>(
                          value: SingingCharacter.jefferson,
                          groupValue: _character,
                          onChanged: (SingingCharacter? value) {
